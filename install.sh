...
echo ""
echo "After registering, run the command below to get admin rights for the user you just registered:"
echo ""
echo "  docker exec -it dispatch_web_1 bash -c 'dispatch user update --role Admin --organization name-of-the-organization email-address-of-registered-user'"
echo ""
